...
class DeviceDelegate {
    ...
    addCover(cover, opts) {
        ...
        return this.createAccessory('cover', 'Cover', new abilities_1.CoverAbility(cover, 'door').setActive(isDoor), new abilities_1.CoverAbility(cover, 'windowCovering').setActive(isWindowCovering), new abilities_1.CoverAbility(cover, 'garageDoorOpener').setActive(isGarageDoorOpener), new abilities_1.CoverAbility(cover, 'window').setActive(!isDoor && !isWindowCovering && !isGarageDoorOpener), new abilities_1.PowerMeterAbility(cover)).setActive(coverOpts.exclude !== true && o.active !== false);
    }
    /**
